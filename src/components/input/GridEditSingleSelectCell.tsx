...
function GridEditSingleSelectCell(props: GridEditSingleSelectCellProps) {
    ...
    const handleChange: SelectProps['onChange'] = async (event) => {
        ...
        const remappedValue = remapValues[formattedTargetValue];

        if (onValueChange) {
            await onValueChange(event, remappedValue);
        }

        await apiRef.current.setEditCellValue({id, field, value: remappedValue}, event);
    };
    ...
    return (
        <rootProps.slots.baseSelect
            ref={ref}
            inputRef={inputRef}
            value={getOptionValue(valueProp)}
            ...
            {valueOptions.map((valueOption) => {
                ...
                return (
                    <rootProps.slots.baseSelectOption
                        ...
                        native={isSelectNative}
                        key={getOptionLabel(valueOption)}
                        value={value}
                    >
